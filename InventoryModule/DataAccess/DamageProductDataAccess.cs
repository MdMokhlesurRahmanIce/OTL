...
{
    public class DamageProductDataAccess : BaseDataAccess
    {
        ...
        public bool Update(DamageProductProvider RequisitionProvider, List<DamageProductDetailProvider> RequisitionDetailProviderList)
        {
            bool IsUpdate = false;
            try
            {
                ...
                command.Connection = Connection;
                command.Transaction = this.Transaction;
                command.CommandText = "DELETE FROM dbo.DamagedProductDetail WHERE DamageID =" + RequisitionID + " ";
                command.ExecuteNonQuery();
        ...
        {
            string filterExpression = "DP.ReferenceNo = " + "'" + code + "'";
            ...
            try
            {
                ...
                command.Connection = Connection;
                command.CommandType = CommandType.StoredProcedure;
                command.CommandText = StoredProcedureNames.DamagedProductGet;
                command.Parameters.Add("@FilterExpression", SqlDbType.VarChar).Value = filterExpression;
