...
{
    public class OtherOutProductProvider : BaseProvider
    {
        #region Properties
        public int ID
        {
        ...
        #region Method
        private OtherOutProductDataAccess dataAccess = new OtherOutProductDataAccess();
        public bool Save(List<OtherOutProductDetailProvider> RequisitionDetailProviderList, out string transactionNo)
        {
        ...
        public bool Update(List<OtherOutProductDetailProvider> RequisitionDetailsProviderList)
        {
