...
{
    public class EngineeringRequisitionDetailProvider : BaseProvider
    {
        #region Properties
        public int ID
        {
        ...
        #region Method
        private EngineeringRequisitionDetailDataAccess dataAccess = new EngineeringRequisitionDetailDataAccess();
        public bool Save()
        {
