...
{    
    public class RequisitionProvider:BaseProvider
    {
        #region Properties
        public int ID
        {
        ...
        #region Method
        private RequisitionDataAccess dataAccess = new RequisitionDataAccess();
        public bool Save(List<RequisitionDetailProvider> RequisitionDetailProviderList, out string transactionNo)
        {
        ...
        public bool Update(List<RequisitionDetailProvider> RequisitionDetailsProviderList)
        {
        ...
        {
            return dataAccess.GetRequisitionwisePOInfo(productID);
        }
        #endregion
    }
}
