<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OtherOutEntryUI.aspx.cs" 
    Inherits="TechnoDrugs.UI.Inventory.OtherOutEntryUI" %>
                        ...
                        <asp:GridView ID="gvRequisition" runat="server" Font-Size="Small" AutoGenerateColumns="False" ShowFooter="True" CssClass="mGrid"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Quantity">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtQuantity" runat="server" Text='<%# Bind("OtherOutQuantity","{0:F5}") %>' onfocus="HideWatermark(this,'0.00')"
