<%@ Page Title="Engineering Requisition" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EngineeringRequisitionUI.aspx.cs" 
    Inherits="TechnoDrugs.UI.Production.EngineeringRequisitionUI" %>
            ...
            <div class="form-wrapper">
                <div style="width: 100%; background-color: #F7F7F7">
                    <div style="width: 35%; float: left">
                        <h2>Requisition from Engineering Department</h2>
                    </div>
                        ...
                        <asp:GridView ID="gvPurchaseForLSE" runat="server" Font-Size="Small" AutoGenerateColumns="False" ShowFooter="True" CssClass="mGrid"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Required Quantity">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtRequiredQuantity" runat="server" Text='<%# Bind("RequiredQuantity") %>' Width="90%" onfocus="HideWatermark(this,'0')"
                                            onblur="ShowWatermark(this,'0')" onkeypress="return isNumberKeyAndDot(event,value);"></asp:TextBox>
                                    </ItemTemplate>
                                    <ItemStyle Width="7%" />
                                    <HeaderStyle HorizontalAlign="Left" Width="7%" />
