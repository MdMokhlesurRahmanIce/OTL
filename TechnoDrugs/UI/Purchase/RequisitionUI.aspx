<%@ Page Title="Requisition Information" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RequisitionUI.aspx.cs"
    Inherits="TechnoDrugs.UI.Purchase.RequisitionUI" %>
                        ...
                        <div class="lblAndTxtStyle">
                            ...
                            <div class="div182Px">
                                <asp:DropDownList ID="ddlRequisitionDivision" runat="server" Width="91%" CssClass="drpwidth99per" DataValueField="ID" DataTextField="Name"
                                    AutoPostBack="True" OnSelectedIndexChanged="ddlRequisitionDivision_SelectedIndexChanged" DataSourceID="odsDivision" AppendDataBoundItems="true">
                        ...
                        <div class="lblAndTxtStyle">
                            ...
                            <div class="div80Px">
                                ...
                                <ajax:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd/MM/yyyy" 
                                    TargetControlID="txtRequisitionDate" PopupButtonID="Image1" Enabled="false" >
                        ...
                        <div class="lblAndTxtStyle">
                            ...
                            <div class="div80Px">
                                <asp:CheckBoxList ID="ckbOption" runat="server" RepeatDirection="Horizontal">
                                    ...
                                    <asp:ListItem Text="Check" Value="2" onclick = "MutExChkList(this);"></asp:ListItem>
                                    <asp:ListItem Text="Approve" Value="3" onclick = "MutExChkList(this);"></asp:ListItem>
                                </asp:CheckBoxList>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="divGridForLSE" runat="server" visible="true">
                        <asp:GridView ID="gvRequisition" runat="server" Font-Size="Small" AutoGenerateColumns="False" ShowFooter="True" CssClass="mGrid"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Requirement">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtRequirement" runat="server" Text='<%# Bind("RequiredQuantity","{0:F5}") %>' onfocus="HideWatermark(this,'0.00')"
                                ...
                                <asp:TemplateField HeaderStyle-HorizontalAlign="Left" HeaderText="Monthly Consumption">
                                    <ItemTemplate>
                                        <asp:TextBox ID="txtMonthlyConsume" runat="server" Text='<%# Bind("MonthlyConsumeQty","{0:F5}") %>'
                                            onfocus="HideWatermark(this,'0.00')" onblur="ShowWatermark(this,'0.00')" onkeypress="return isNumberKeyAndDot(event,value);"
                                            Width="90%"></asp:TextBox>
                                    </ItemTemplate>
                                    <ItemStyle Width="7%" />
                                    <HeaderStyle HorizontalAlign="Left" Width="7%" />
