<%@ Page Title="Production Requisition Report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProductionRequisitionReportUI.aspx.cs" Inherits="TechnoDrugs.Reports.ReportUI.ProductionRequisitionReportUI" %>
            ...
            <div class="form-wrapper">
                <div style="width: 100%; background-color: #F7F7F7">
                    <div style="width: 30%; float: left">
                        <h2>Production Requisition Report</h2>
                    </div>
                    ...
                    <div style="width: 33%; float: left">
                        <div class="lblAndTxtStyle">
                            <div class="divlblwidth100px">
                                <asp:Label ID="lblPurchaseOrderDivision" runat="server" Text="Requisition Division"></asp:Label>
                            </div>
                            <div class="div182Px">
                                <asp:DropDownList ID="ddlProdRequiDivision" runat="server" Width="91%" CssClass="drpwidth99per" DataValueField="ID" DataTextField="Name"
                        ...
                        <div class="lblAndTxtStyle">
                            <div class="divlblwidth100px">
                                <asp:Label ID="Label6" runat="server" Height="14px" Text="Ref. No"></asp:Label>
                            </div>
                            <div class="div80Px">
