...
{
    public partial class BOEReportUI : PageBase
    {
         string mode = "";
         public BOEReportUI()
         {
        ...
        protected void btnPreview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string page = "GeneralReportViewerUI.aspx?ReportType=" + ReportType.BOEReport + "&reportOption=" + reportOption + "&reportCategory=" + reportCategory + "&fromDate=" + fromDate + "&todate=" + todate + "&adate=" + adate + "&transactionNo=" + transactionNo;
