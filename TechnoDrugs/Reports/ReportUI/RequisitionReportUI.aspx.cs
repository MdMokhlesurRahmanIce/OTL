...
{
    public partial class RequisitionReportUI : PageBase
    {
        string mode = "";
        public RequisitionReportUI()
           {
        ...
        protected void btnPreview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string page = "GeneralReportViewerUI.aspx?ReportType=" + ReportType.RequisitionReport + "&reportOption=" + reportOption + "&reportCategory=" + reportCategory + "&fromDate=" + fromDate + "&todate=" + todate + "&adate=" + adate + "&transactionNo=" + transactionNo;
