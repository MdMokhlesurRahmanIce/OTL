...
<style type="text/css">
    ...
    <script type="text/javascript">
        ...
        function checkBoxClicked(cbxSelect, cbxAdd, cbxEdit, cbxDelate, cbxPreview, cbxPrint, cbxAll, ctl) {
            ...
            var cbkPrint = document.getElementById(cbxPrint);
            var cbkAll = document.getElementById(cbxAll);
            var itemChecked = getCheckedItem(cbxSelect, cbxAdd, cbxEdit, cbxDelate, cbxPreview, cbxPrint, cbxAll, ctl);
            if (itemChecked == "false") {
                if (ctl == "SELECT") {
                    ...
                    if (cbkPrint.checked == true) {
                        cbkPrint.checked = true;
                    }
                    else {
                        cbkPrint.checked = false;
                    }
                }
                else if (ctl == "ALL") {
        ...
        function getCheckedItem(cbxSelect, cbxAdd, cbxEdit, cbxDelate, cbxPreview, cbxPrint, cbxAll, ctl) {
            var cbkSelect = document.getElementById(cbxSelect);
            var cbkAdd = document.getElementById(cbxAdd);
            var cbkEdit = document.getElementById(cbxEdit);
            var cbkDelate = document.getElementById(cbxDelate);
            ...
            <div>
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Print">
                                    <HeaderTemplate>
                                        <asp:CheckBox ID="chkPrintAll" runat="server" AutoPostBack="True" 
                                            OnCheckedChanged="chkPrintAll_CheckedChanged" Text="  Print" Width="80px" />
                                    </HeaderTemplate>
                                    <ItemTemplate>
                                        <asp:CheckBox ID="chkPrint" runat="server" Checked='<%#Bind("CanPrint")%>'/>
                                    </ItemTemplate>
                                </asp:TemplateField>
                           </Columns>
